...
double estimate_special_stats_high(const Special_stats& special_stats)
{
    ...
    high_estimation +=
        special_stats.attack_power + special_stats.hit * hit_w + special_stats.critical_strike * crit_w + special_stats.expertise * 
        expertise_w + special_stats.gear_armor_pen * arpen_w + special_stats.haste * haste_w;
...
double estimate_special_stats_low(const Special_stats& special_stats)
{
    ...
    low_estimation += special_stats.attack_power + special_stats.hit * hit_w_cap +
                      ...
                      special_stats.gear_armor_pen * arpen_w + special_stats.haste * haste_w;
...
bool estimate_special_stats_smart_no_skill(const Special_stats& special_stats1, const Special_stats& special_stats2)
{
    ...
    diff.haste > 0 ? res_2.haste = diff.haste : res_1.haste = -diff.haste;
