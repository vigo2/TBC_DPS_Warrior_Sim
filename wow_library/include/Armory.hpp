    ...
    std::vector<Weapon> two_handed_axes_polearm_t
            {
                ...
                {"singing_crystal_axe", Attributes{0.0, 0.0}, Special_stats{0.0, 0.0, 0.0, 0, 0.0}, 3.5, 295, 444, Weapon_socket::two_hand, Weapon_type::axe, {{"singing_crystal_axe", Hit_effect::Type::stat_boost, {}, {0, 0, 0, 0, .253}, 0, 10, 0, 3.5 / 60}}},  
